      ...
      <div className="crop-area" style={{ display: 'flex', gap: 16 }}>
        <div style={{ position: 'relative', border: '1px solid #ddd' }}>
          ...
          {selRect && (
            <div
              style={{
                position: 'absolute',
                left: `${(selRect.x / (canvasRef.current?.width || 1)) * 100}%`,
                top: `${(selRect.y / (canvasRef.current?.height || 1)) * 100}%`,
                width: `${(selRect.w / (canvasRef.current?.width || 1)) * 100}%`,
                height: `${(selRect.h / (canvasRef.current?.height || 1)) * 100}%`,
        ...
        <div style={{ minWidth: 260 }}>
          <div className="upload-controls" style={{ marginBottom: 16 }}>
            <div className="select-file-box" style={{ marginBottom: 12, padding: 8, border: '1px solid #ddd', borderRadius: 4 }}>
          ...
          <div style={{ marginTop: 16 }}>
            <button className="btn" onClick={handleCrop} disabled={!selRect}>Crop</button>
